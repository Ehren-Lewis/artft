...
//Both this and the sign up are fake. They are being implemented to test user flow
...
const ArtistLogin = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const authData = await pocketDB.collection('fakeartistauth').authWithPassword(
            `${formValues.username}`,
            `${formValues.password}`,
        );
            ...
            <div className="w-1/2 mx-auto self-center rounded">
                <form className="w-3/4 h-3/4 bg-slate-900/50 px-6 py-3  mx-auto rounded">
                    ...
                    <div className="">
                        ...
                        <p className="inline-block w-1/3">Don't have an account?</p>
                        <Link href="./signup" className="inline-block w-1/3 underline">Sign Up</Link>
                    </div>
